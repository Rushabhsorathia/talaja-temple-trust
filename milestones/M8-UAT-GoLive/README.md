# Milestone 8 – UAT, Training & Go-Live

**Duration:** Weeks 11–12
**Goal:** Validate with trust stakeholders, train users, deploy to production, handover.
**Exit Criteria:** Production live, UAT signed off, training delivered, docs handed over.

| Ticket | Title | Story Points |
|--------|-------|--------------|
| [M8-T1](M8-T1-UAT-Execution.md) | UAT execution with trustees | 5 |
| [M8-T2](M8-T2-Bug-Fixes.md) | UAT bug fixes & sign-off | 5 |
| [M8-T3](M8-T3-Data-Migration.md) | Content & donor data migration | 5 |
| [M8-T4](M8-T4-Training.md) | Admin/devotee training + manuals | 3 |
